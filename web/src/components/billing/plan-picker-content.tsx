...
const planCardDefault = "border-white/70 ring-1 ring-gray-900/5 shadow-[0_8px_28px_rgba(17,24,39,0.05)]";
...
export function PlanPickerContent({ variant = "page" }: PlanPickerContentProps) {
    ...
    <>
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 text-left md:grid-cols-2 md:items-stretch">
        {PLAN_OFFERS.map((offer) => {
          ...
          return (
            <div key={offer.slug} className={`${planCardBase} ${isPro ? planCardPopular : planCardDefault}`}>
