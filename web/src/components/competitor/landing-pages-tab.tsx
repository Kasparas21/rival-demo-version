...
export const LANDING_PAGES_LIST_CACHE_VERSION = "v5";
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          <span className="min-w-0 truncate font-mono text-[12px] text-slate-900" title={row.url}>
            {display}
          </span>
          {row.isTracking ? (
            <span
              className="flex h-[18px] w-[18px] shrink-0 items-center justify-center rounded-full bg-emerald-500 text-white"
          ...
          <span className="ml-auto shrink-0 text-[13px] font-bold text-[color:var(--rival-primary)]">{row.count}</span>
        </div>
