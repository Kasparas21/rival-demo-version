  ...
  if (standaloneMode) {
    if (!competitor.audience) {
      return (
        <ComparisonPanelShell
          title="Audience inference"
          subtitle={`Inferred positioning for ${competitor.name}`}
          tooltip="Generated during strategy recompute and cached on the overview payload."
        >
          <ComparisonInsufficient message="No audience inference for this brand yet. Run a strategy recompute and try again." />
        </ComparisonPanelShell>
      );
    }
    return (
