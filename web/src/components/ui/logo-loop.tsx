...
function useResizeObserver(
  ...
  }, [callback, containerRef, seqRef, logos, gap, logoHeight, isVertical]);
}
...
function useImageLoader(
  ...
  }, [onLoad, seqRef, logos, gap, logoHeight, isVertical]);
}
  ...
  const renderLogoItem = useCallback(
    (item: LogoItem, key: Key) => {
      ...
      const content = isNodeItem ? (
        ...
        // eslint-disable-next-line @next/next/no-img-element -- LogoLoop measures intrinsic img layout; matches React Bits
        <img
          src={item.src}
          srcSet={item.srcSet}
          sizes={item.sizes}
