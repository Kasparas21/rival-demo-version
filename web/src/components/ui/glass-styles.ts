...
export const glassPillShellClass =
  "border border-white/60 bg-white/38 shadow-[inset_0_1px_0_rgba(255,255,255,0.88),0_14px_48px_-12px_rgba(31,38,135,0.22),0_4px_16px_-4px_rgba(74,127,165,0.12)] backdrop-blur-xl backdrop-saturate-[1.45] ring-1 ring-white/45 transition-[background-color,border-color,box-shadow] duration-300 hover:border-white/70 hover:bg-white/46";
