...
export function InstagramPostCard({ post, socials, highlightEngagement, className }: PlatformCardProps) {
  ...
  return (
    <PlatformChrome platform="instagram" className={cn(highlightEngagement && "ring-2 ring-amber-300", className)}>
      ...
      <div className="space-y-2 px-3 py-2.5">
        ...
        <ExternalPlatformLink platform="instagram" postUrl={post.post_url} />
      </div>
    </PlatformChrome>
  );
}
