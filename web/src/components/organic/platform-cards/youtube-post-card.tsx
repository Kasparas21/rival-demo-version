...
export function YouTubePostCard({ post, socials, highlightEngagement, className }: PlatformCardProps) {
  ...
  return (
    <PlatformChrome platform="youtube" className={cn(highlightEngagement && "ring-2 ring-amber-300", className)}>
