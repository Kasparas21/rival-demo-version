...
import { BarChart3, ExternalLink, Loader2, Trophy } from "lucide-react";
      ...
      <td className="px-3 py-3">
        <div className="flex items-center gap-2">
          {row.logo_url ? (
            ...
            <img src={row.logo_url} alt="" className="h-7 w-7 rounded-md border border-slate-200 object-cover" />
          ) : (
              ...
              <table className="w-full min-w-[880px] text-left text-sm">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/80 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                    ...
                    <th className="px-2 py-2.5 text-center">Launched</th>
                    <th className="px-2 py-2.5 text-center">Killed</th>
                    <th className="px-2 py-2.5 text-center">Net</th>
                    <th className="px-2 py-2.5 text-center">Winners</th>
                    <th className="px-2 py-2.5 text-center">Longest</th>
                    <th className="px-2 py-2.5 text-center">Total runtime</th>
                  </tr>
                </thead>
                <tbody>
                  {stats.competitors.map((row: DiscoveryStatsCompetitorRow) => (
                    <LeaderboardRow
