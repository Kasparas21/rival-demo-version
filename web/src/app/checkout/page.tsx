...
export default async function CheckoutPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fb] px-4 py-12 sm:px-6 sm:py-16">
      <div className="mx-auto max-w-xl rounded-3xl border border-[#ececef] bg-white p-6 shadow-[0_18px_60px_rgba(15,23,42,0.08)] sm:p-8">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#4a7fa5]">Spy Rival subscription</p>
        <h1 className="mt-3 text-2xl font-bold tracking-tight text-[#1a1a2e] sm:text-3xl">Start your 1-day free trial</h1>
        <p className="mt-3 text-sm leading-6 text-[#52525b]">
