...
export function RedditLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 216 216" className={className || svgClass}>
      <defs>
        <radialGradient id="reddit-snoo-1" cx="169.75" cy="92.19" r="50.98" fx="169.75" fy="92.19" gradientTransform="matrix(1 0 0 .87 0 11.64)" gradientUnits="userSpaceOnUse">
        ...
        <radialGradient href="#reddit-snoo-1" id="reddit-snoo-2" cx="47.31" r="50.98" fx="47.31" />
        <radialGradient href="#reddit-snoo-1" id="reddit-snoo-3" cx="109.61" cy="85.59" r="153.78" fx="109.61" fy="85.59" gradientTransform="matrix(1 0 0 .7 0 25.56)" />
        <radialGradient id="reddit-snoo-4" cx="-6.01" cy="64.68" r="12.85" fx="-6.01" fy="64.68" gradientTransform="matrix(1.07 0 0 1.55 81.08 27.26)" gradientUnits="userSpaceOnUse">
        ...
        <radialGradient href="#reddit-snoo-4" id="reddit-snoo-5" cx="-73.55" cy="64.68" r="12.85" fx="-73.55" fy="64.68" gradientTransform="matrix(-1.07 0 0 1.55 62.87 27.26)" />
        <radialGradient id="reddit-snoo-6" cx="107.93" cy="166.96" r="45.3" fx="107.93" fy="166.96" gradientTransform="matrix(1 0 0 .66 0 57.4)" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#172e35" />
          <stop offset=".29" stopColor="#0e1c21" />
          <stop offset=".73" stopColor="#030708" />
          <stop offset="1" />
        </radialGradient>
        <radialGradient href="#reddit-snoo-1" id="reddit-snoo-7" cx="147.88" cy="32.94" r="39.77" fx="147.88" fy="32.94" gradientTransform="matrix(1 0 0 .98 0 .54)" />
        <radialGradient id="reddit-snoo-8" cx="131.31" cy="73.08" r="32.6" fx="131.31" fy="73.08" gradientUnits="userSpaceOnUse">
      ...
      <circle cx="169.22" cy="106.98" r="25.22" fill="url(#reddit-snoo-1)" />
      <circle cx="46.78" cy="106.98" r="25.22" fill="url(#reddit-snoo-2)" />
      <ellipse cx="108.06" cy="128.64" fill="url(#reddit-snoo-3)" rx="72" ry="54" />
      <path fill="url(#reddit-snoo-4)" d="M86.78 123.48c-.42 9.08-6.49 12.38-13.56 12.38s-12.46-4.93-12.04-14.01c.42-9.08 6.49-15.02 13.56-15.02s12.46 7.58 12.04 16.66Z" />
      <path fill="url(#reddit-snoo-5)" d="M129.35 123.48c.42 9.08 6.49 12.38 13.56 12.38s12.46-4.93 12.04-14.01c-.42-9.08-6.49-15.02-13.56-15.02s-12.46 7.58-12.04 16.66Z" />
      <ellipse cx="79.63" cy="116.37" rx="2.8" ry="3.05" fill="#000" />
      <ellipse cx="146.21" cy="116.37" rx="2.8" ry="3.05" fill="#000" />
      <path fill="url(#reddit-snoo-6)" d="M108.06 142.92c-8.76 0-17.16.43-24.92 1.22-1.33.13-2.17 1.51-1.65 2.74 4.35 10.39 14.61 17.69 26.57 17.69s22.23-7.3 26.57-17.69c.52-1.23-.33-2.61-1.65-2.74-7.77-.79-16.16-1.22-24.92-1.22Z" />
      <circle cx="147.49" cy="49.43" r="17.87" fill="url(#reddit-snoo-7)" />
      <path fill="url(#reddit-snoo-8)" d="M107.8 76.92c-2.14 0-3.87-.89-3.87-2.27 0-16.01 13.03-29.04 29.04-29.04 2.14 0 3.87 1.73 3.87 3.87s-1.73 3.87-3.87 3.87c-11.74 0-21.29 9.55-21.29 21.29 0 1.38-1.73 2.27-3.87 2.27Z" />
